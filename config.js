...
module.exports = {
  botname: process.env.BotName || "𝐒𝐀𝐀𝐃𝐈-𝐌𝐃 👾", 
  author: process.env.Author || "@Saadi-bot",
  packname: process.env.PackName || "Saadi  v2 MD",
  socialLink: process.env.Web || "https://github.com/PikaBotz",
  footer: process.env.Footer || "© Saadi-md Bot",
  prefa: process.env.Prefix || ['-'],
  themeemoji: process.env.ThemeEmoji || "🎐",
  ownername: process.env.Owner_Name || "Pika~Kun",
  ownernumber: process.env.Owner_Number || "923165202412",
